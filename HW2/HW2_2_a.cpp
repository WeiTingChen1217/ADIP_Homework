        ...
        for (int z = 0; z < 7; z++){
            ...
            for (int i = 0; i < matDst1.cols; ++i)
                for (int j = 0; j < matDst1.rows; ++j){
                    MSE += pow(matSrc.at<uchar>(j, i) & a, 2) / sizeSrc_width * sizeSrc_width;
                    matDst1.at<uchar>(j, i) = matSrc.at<uchar>(j, i) & a;
//                    // 觀察每個 bit 的型態，並二值化
